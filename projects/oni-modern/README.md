...
> [!CAUTION]
> The launcher changes files in your Oni folder. Before you start, make your own full copy of that folder as well. Oni Modern is provided as is, without warranty of any kind (see [LICENSE](LICENSE)); you use it at your own risk.

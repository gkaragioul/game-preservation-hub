...
def cover(c):
    ...
    c.drawString(50, 50, "VERSION 1.0  /  LOCAL BUILD AND VERIFICATION REPORT")
...
def verification(c):
    ...
    text_block(c, "This is a local modernization report, not legal advice. The project does not redistribute Oni game files, extracted assets, a patched game folder or the upstream runtime archive.", 40, 450, 860, "Arial", 11, 15, MUTED)
    rows = [
        ("ONI MODERN", "Original launcher and profile code for this project. No game assets are included."),
        ("DAODAN DLL / FPSDAODAN", "Used locally as the modern runtime. Sources: wiki.oni2.net/Daodan_DLL and mods.oni2.net/system/files/DaodanDLL.zip. The archive carries a BSD-style ODE notice at fps/ode_license.txt only; no archive-wide redistribution license was found."),

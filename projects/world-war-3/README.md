...
- **Simple download:** [Download the World War 3 source ZIP](https://github.com/gkaragioul/game-preservation-hub/releases/download/project-downloads-v1/world-war-3.zip). This archive contains only this project.

...
macro(plat_link_and_package)
    ...
    target_link_libraries(sith_engine PRIVATE mingw32 ${SDL2_COMMON_LIBS} version imm32 setupapi gdi32 winmm imm32 ole32 oleaut32 shell32 winmm user32 comctl32 crypt32 advapi32) # mingw32 must precede SDL::SDL so its runtime startup provides the entry point SDL3's built-in WinMain expects

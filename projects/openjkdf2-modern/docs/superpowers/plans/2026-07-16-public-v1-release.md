...
**Files:**
- Create: `<portfolio-site>/src/pages/OpenJKDF2EnhancedPage.jsx`
- Create: `<portfolio-site>/public/openjkdf2-enhanced-gameplay.jpg`
- Create: `<portfolio-site>/public/openjkdf2-enhanced-modern-controls.jpg`
- Create: `<portfolio-site>/public/openjkdf2-enhanced-display-options.jpg`
- Create: `<portfolio-site>/public/openjkdf2-enhanced-diagnostics.jpg`
- Modify: `<portfolio-site>/src/App.jsx`
- Modify: `<portfolio-site>/api/download/[tool].js`
- Modify: `<portfolio-site>/tools/prerender.js`
- Modify: `<portfolio-site>/public/sitemap.xml`
...
Lazy-load `OpenJKDF2EnhancedPage`, register `/openjkdf2-enhanced`, add the project card/link, add the route to `tools/prerender.js`, and add the page's canonical URL to the sitemap.
...
**Files:**
- Vercel production deployment for the portfolio site (since retired)
...
```powershell
curl.exe -I https://<portfolio-site>/openjkdf2-enhanced
curl.exe -I https://<portfolio-site>/download/openjkdf2-enhanced
```

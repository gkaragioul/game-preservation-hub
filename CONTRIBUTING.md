...
Start with the project's README and reproduce a specific behavior in your own test environment. Record the software version, operating system, architecture, steps taken, and observed result. File metadata or dependency lists alone are not evidence that a game works.
